        ...
        <div
            ...
            <form @submit.prevent="handleSubmit" class="flex flex-col w-full gap-4">
                ...
                <div class="flex flex-row gap-4 w-full">
                    <div class="w-1/2">
                        <input
                            class="w-full bg-blue-3/50 border border-blue-4/30 rounded-xl p-3 placeholder-grey-1 focus:ring-2 focus:ring-purple focus:outline-none text-white transition-all"
                ...
                <div class="w-full">
                    ...
                    <div v-show="submitted && !password" class="text-yellow text-xs mt-1 ml-1">Password is required
                    </div>
                </div>
    ...
    methods: {
        handleSubmit() {
            ...
            if (!(passPattern.test(password))) {
                this.error = "Password must be 8-16 chars containing an uppercase, lowercase, number, and special character";
                return;
            }
